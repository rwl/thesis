...
the module.  Softmax and $\epsilon$-greedy explorer are implemented for
explorations of discrete action sets.  Policy gradient methods use a module
that adds Gaussian noise to the output of the policy function approximator
module and the standard deviation $\sigma$ of the normal distribution may be
manually adjusted after each episode of a simulation.
