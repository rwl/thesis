...
define an optimisation problem that is used to model a centralised market/system
operator entity.
...
pool markets has resulted in it becoming one of the most widely studied subjects in
