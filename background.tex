...
broadly define the sytems that require modelling. Market simulation techniques
...
reactive power component in is nil and more active power flow can be
...
matrix $Y$.  The current injected at bus $i$ is
\begin{equation}
