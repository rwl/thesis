...
purchasing large volumes of power for many customers.  Sizeable amounts of time
and effort are typically required for these long-term contracts to be initially
...
look-up table parameterization to many problems \cite{bertsekas:96}.  However,
...
These algoithms have lengthy derivations, but an overview has been published by
\citeA{petersScholar}.
...
properties and have been sucessfully applied in laboratory and operational
settings.
