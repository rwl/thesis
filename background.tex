...
typical formulation of $Y$ is given in Section \ref{sec:acpf}.  Crucially, the
relationship between nodal voltages and power entering the network is
...
settings.  If the optimisation variable $x$ is empty the formulation reduces to
a power flow problem as described in Section \ref{sec:pf_form}, above.
