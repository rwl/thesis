...
around the mean once converged due to the use of Boltmann exploration with a
...
$\epsilon$-greedy action selection and can be removed if a Boltmann explorer is
used.
...
\ifthenelse{\boolean{includefigures}}{
	\begin{figure}
	  \centering
	  \includegraphics{figures/fig6_1_reward_a1}
	  \caption{Agent 1 profits.}
	  \label{fig:6_1_reward_a1}
	\end{figure}

	\begin{figure}
	  \centering
	  \includegraphics{figures/fig6_1_reward_a2}
	  \caption{Agent 2 profits.}
	  \label{fig:6_1_reward_a2}
	\end{figure}

	\begin{figure}
	  \centering
	  \includegraphics{figures/fig6_1_reward_a3}
	  \caption{Agent 2 profits.}
	  \label{fig:6_1_reward_a3}
	\end{figure}

	\begin{figure}
	  \centering
	  \includegraphics{figures/fig6_1_reward_a4}
	  \caption{Agent 2 profits.}
	  \label{fig:6_1_reward_a4}
	\end{figure}
}{}
