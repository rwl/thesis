...
As in \citeA{krause:nash06}, no specific load profile is defined. The
...
standard deviation over 10 simulation runs for Agent 2 operating policy
gradient methods under price configuration 1 with an increased learning rate of
0.05. Figure \ref{fig:5_4_action_a2} shows the same infomation, but with a
reduced learning rate of 0.005.
