...
conditions and to imporove performance using complex continuous state
representations.
...
state data and produce offers for diverse portfilios of generators with
...
This final section highlights some of the shortcommings of the methodology
