...
applied to complex problems.  Function approximation techniques (e.g.~artificial
neural networks) can be used to apply these methods to
continuous environment representations, but have been shown to cause convergence
or even diverge problems when approximating a value function
