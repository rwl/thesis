...
% : Powergen (now owned by German Utility E.ON), National Power and
% Nuclear Electric (Nuclear Electric + Scottish Nuclear = British Energy).  The
% Electricity Council set the prices for electricity according to financial
