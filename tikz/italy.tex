...
\node[vbus,minimum height=20mm,label=above:Sicily] (sicily) at (csicily) {};
\node[hbus,label=above left:PRGP] (prgp) at (cprgp) {};
\node[hbus,minimum width=20mm,label=left:ROSN] (rosn) at (crosn) {};
\node[hbus,label=above right:BRNN] (brnn) at (cbrnn) {};
\node[vbus,minimum height=25mm,label=above:South] (south) at (csouth) {};
\node[vbus,minimum height=10mm,label=above:FOGN] (fogn) at (cfogn) {};
\node[vbus,minimum height=20mm,label=above:Central South] (cs) at (ccs) {};
\node[vbus,minimum height=30mm,label=above:Central North] (cn) at (ccn) {};
\node[vbus,minimum height=20mm,label=above right:Sardinia] (sard) at
(csardinia) {};
\node[vbus,minimum height=15mm,label=above:MFTV] (mftv) at
(cmftv) {};
\node[hbus,minimum width=30mm,label=right:North] (north) at (cnorth) {};
...
\node[genset,pin={[pin distance=2mm]95:14000 MW}] (ccnorth) at
($(cnorth)+(-0.5,0.5)$) {\sffamily\tiny CC};
\draw[overhead] ([xshift=-5mm] north.north) -- (ccnorth.south);
\node[genset,pin={[pin distance=5mm]above:796 MW}] (rpnorth) at
($(cnorth)+(0,0.5)$) {\sffamily\tiny RP};
\draw[overhead] ([xshift=0mm] north.north) -- (rpnorth.south);
\node[genset,pin={[pin distance=2mm]75:3015 MW}] (ofnorth) at
