...
%        online\newline
  ...
  \end{tikzpicture}
  \caption{Class diagram for the Pylon power system model illustrating
  required associations between branch, bus and generator classes. Mathematical
  symbols for vectors of object attributes are shown in grey, where
  {\color{gray} $S_{b}$} is the system base MVA used in per-unit calculation.}
\end{figure}
