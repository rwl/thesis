\newcommand{\genunit}[4]{
  ...
  shadow,fill=white,#3] (#1) at (#2) {\scriptsize#4};
...
\begin{tikzpicture}[thick,label distance=0mm]
  ...
  \tikzstyle{busbar} = [rectangle,draw,fill=black,inner sep=0pt,drop
  shadow];
...
\node[hbus,minimum width=15mm,label=left:Bus 1] (bus1) at (4.5,0) {};
\node[hbus,minimum width=15mm,label=right:Bus 2] (bus2) at (7,0) {};
\node[hbus,label=right:Bus 3] (bus3) at (0,6) {};
\node[vbus,label=above:Bus 4] (bus4) at (2.75,4) {};
...
% Generator @ Bus 1.
\genunit{gen1}{4.0,-0.8}{label=left:152 MW,pin={[pin distance=12mm,text
centered,text width=10.5mm]165:2$\times$U76}}{A1};
\draw[overhead] ([xshift=-5mm] bus1.south) -- (gen1.north);
% Generator @ Bus 2.
\genunit{gen2}{7.5,-0.8}{label=right:152 MW,pin={[pin distance=12mm,text
centered,text width=10.5mm]15:2$\times$U76}}{A2};
\draw[overhead] ([xshift=5mm] bus2.south) -- (gen2.north);
% Generator @ Bus 7.
\genunit{gen3}{11,-0.3}{label=right:300 MW,pin=below:3$\times$U100}{A4};
...
width=20mm]right:Synch. Cond.}}{A5};
\draw[overhead] ([yshift=3mm] bus14.east) -- (gen5.west);
% Generator @ Bus 15.
\genunit{gen6}{0.5,11.2}{label={[text centered,text width=10mm]below:155
MW}}{A1};
\draw[overhead] (bus15.south) -- (gen6.north);
% Generator @ Bus 16.
\genunit{gen7}{0.0,15}{label=right:155 MW}{A2};
\draw[overhead] (bus16.north) -- (gen7.south);
% Generator @ Bus 18.
\genunit{gen8}{1.5,18.8}{label=left:400 MW,pin={[pin distance=6mm]below
left:Nuclear}}{A1};
\draw[overhead] ([xshift=-5mm] bus18.north) -- (gen8.south);
% Generator @ Bus 21.
\genunit{gen9}{5,17.8}{label=right:400 MW,pin={above right:Nuclear}}{A2};
\draw[overhead] (bus21.north) -- (gen9.south);
% Generator @ Bus 22.
\genunit{gen10}{9,17.8}{label=right:300 MW,pin={above:Hydro,
6$\times$U50}}{A3};
\draw[overhead] (bus22.north) -- (gen10.south);
% Generator @ Bus 23.
\genunit{gen11}{11.85,15.05}{label=below:660 MW,pin={[text centered,text
width=15mm]above:2$\times$U155 1$\times$U350}}{A4};
...
% Area voltage labels.
\node[draw,fill=white,drop shadow] at (0.5,1.5) {\normalsize{138 kV}};
\node[draw,fill=white,drop shadow] at (6.5,10.3) {\normalsize{230 kV}};
