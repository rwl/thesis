...
\newcommand{\genset}[3]{
  \node[circle,draw,thick,minimum width=7mm,inner sep=0pt,drop
...
\begin{footnotesize}
\node[hbus,minimum width=16mm,label=left:Bus 1] (b1) at (c1) {};
\node[hbus,minimum width=25mm,label=left:Bus 2] (b2) at (c2) {};
\node[hbus,minimum width=16mm,label=right:Bus 3] (b3) at (c3) {};
\node[hbus,minimum width=16mm,label=left:Bus 4] (b4) at (c4) {};
\node[hbus,minimum width=25mm,label=left:Bus 5] (b5) at (c5) {};
\node[hbus,minimum width=16mm,label=right:Bus 6] (b6) at (c6) {};
\end{footnotesize}
