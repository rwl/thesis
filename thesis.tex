...
similarly grateful for the work by researchers at Dalle Molle Institute for Artificial
Intelligence (IDSIA) and the Technical University of Munich on reinforcement
learning algorithm and artificial neural network implementations.
...
purpose. In this thesis electricity markets are modelled as non-linear constrained
...
several possibilities for improving the approach taken are identified.
Further development of this research could lead to unsupervised learning algorithms
